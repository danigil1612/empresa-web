  ...
  es: {
    ...
    demo: {
      ...
      form: {
        ...
        subheading: 'Te responderemos personalmente lo antes posible.',
        ...
        consent: 'He leído la información sobre protección de datos y la',
        consentLink: 'política de privacidad',
        submit: 'Solicitar demo',
        note: 'Tus datos se utilizarán únicamente para atender esta solicitud.',
        privacySummary: {
          title: 'Información básica sobre protección de datos',
          controller: 'Responsable: INHARI BASE S.L.',
          purpose: 'Finalidad: gestionar tu solicitud y preparar la demostración.',
          basis: 'Legitimación: medidas precontractuales solicitadas por ti.',
          recipients: 'Destinatarios: proveedores necesarios y autoridades cuando exista obligación legal.',
          rights: 'Derechos: acceso, rectificación, supresión y demás derechos en xavi@inhari.cat.',
          more: 'Más información en la política de privacidad.',
        },
      },
      success: {
        eyebrow: 'Solicitud enviada',
        title: 'Gracias por contactar con Pulse.',
        text: 'Hemos recibido tus datos y te responderemos lo antes posible.',
      },
      after: {
  ...
  ca: {
    ...
    demo: {
      ...
      form: {
        ...
        subheading: 'Et respondrem personalment al més aviat possible.',
        name: 'Nom i cognoms',
        ...
        consent: 'He llegit la informació sobre protecció de dades i la',
        consentLink: 'política de privacitat',
        submit: 'Demanar demo',
        note: 'Les teves dades s’utilitzaran únicament per atendre aquesta sol·licitud.',
        privacySummary: {
          title: 'Informació bàsica sobre protecció de dades',
          controller: 'Responsable: INHARI BASE S.L.',
          purpose: 'Finalitat: gestionar la teva sol·licitud i preparar la demostració.',
          basis: 'Legitimació: mesures precontractuals sol·licitades per tu.',
          recipients: 'Destinataris: proveïdors necessaris i autoritats quan hi hagi obligació legal.',
          rights: 'Drets: accés, rectificació, supressió i altres drets a xavi@inhari.cat.',
          more: 'Més informació a la política de privacitat.',
        },
      },
      success: {
        eyebrow: 'Sol·licitud enviada',
        title: 'Gràcies per contactar amb Pulse.',
        text: 'Hem rebut les teves dades i et respondrem al més aviat possible.',
      },
      after: {
  ...
  en: {
    ...
    demo: {
      ...
      form: {
        ...
        subheading: 'We will reply personally as soon as possible.',
        name: 'Full name',
        ...
        consent: 'I have read the data protection information and the',
        consentLink: 'privacy policy',
        submit: 'Request demo',
        note: 'Your data will only be used to handle this request.',
        privacySummary: {
          title: 'Basic data protection information',
          controller: 'Controller: INHARI BASE S.L.',
          purpose: 'Purpose: manage your request and prepare the demonstration.',
          basis: 'Lawful basis: pre-contractual steps requested by you.',
          recipients: 'Recipients: necessary service providers and authorities where legally required.',
          rights: 'Rights: access, rectification, erasure and other rights at xavi@inhari.cat.',
          more: 'More information in the privacy policy.',
        },
      },
      success: {
        eyebrow: 'Request sent',
        title: 'Thank you for contacting Pulse.',
        text: 'We have received your details and will reply as soon as possible.',
      },
      after: {
